...
import { InputField, FileInputField, TextareaField } from '../components/ui/input';
        ...
        <div class='flex flex-col md:flex-row items-start md:items-center justify-between gap-4'>
          <div>
            ...
            <p class='text-sm text-slate-600 font-medium mt-1'>
              ...
              {' · '}
              <a href={'/projects/' + project.id + '/gallery'} class='text-accent hover:underline font-semibold'>Projekt-Galerie</a>
            </p>
          </div>
